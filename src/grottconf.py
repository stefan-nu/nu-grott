...
class Conf :
    ...
    def set_default_config(self) :
        ...
        self.pvdisv1         = False # if True disable sending of energy value (v1) to PVoutput 
        self.pvtemp          = False # if True also send temperature to PVoutput
        self.pvuplimit       = 5     # minimal time delay in minutes between two PVoutput updates
    ...
    def process_config_file(self):
        ...
        # exceptions and keep the default parameter in place. To do so, the code
        # should be changed to a loop
    ...
    def set_reclayouts(self):
        ...
        self.recorddict6 = {"T06NNNNXSPH": 
            ...
            "pvfrequency "       : {"value" :306, "length" :  2, "type" : "num",  "divide" :   100                 },
        ...
        self.recorddict13 = {"T06NNNNXSPA": {
            ...
            "acchargeenergytodayh":{"value" : 654, "length" :  2, "type" : "num",  "divide" :  10,"incl" : "no"},
            "group2start"        : {"value" : 658, "length" :  2, "type" : "num",                 "incl" : "no"},
            "group2end"          : {"value" : 662, "length" :  2, "type" : "num",                 "incl" : "no"},
            "acchargeenergytoday": {"value" : 666, "length" :  2, "type" : "num",  "divide" :  1               },
